...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'callTargetPhone',
      title: 'Call target phone',
      type: 'string',
      readOnly: true,
    }),
    ...
    defineField({
      ...
      options: {
        list: [
          {title: 'Landing Page', value: 'landing-page'},
          {title: 'Main Website', value: 'main-website'},
        ],
      },
      readOnly: true,
    }),
    ...
    defineField({name: 'landingPage', title: 'Entry/page path', type: 'string', readOnly: true}),
